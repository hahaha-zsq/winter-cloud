...
public class I18nMessageRunner {
    ...
    public void start() {
         ...
         * TTL 确保 TraceId 等上下文信息能正确传递到异步线程
         */
        CompletableFuture.runAsync(() -> {
            log.info("开始 I18n 缓存预热...");
    ...
    public void initBloomFilter() {
        try {
            // 创建布隆过滤器
            RBloomFilter<Object> bloomFilter = redissionTemplate.createBloomFilter(CommonConstants.I18nMessage.I18N_BLOOM_FILTER_NAME, CommonConstants.I18nMessage.I18N_BLOOM_EXPECTED_INSERTIONS,
