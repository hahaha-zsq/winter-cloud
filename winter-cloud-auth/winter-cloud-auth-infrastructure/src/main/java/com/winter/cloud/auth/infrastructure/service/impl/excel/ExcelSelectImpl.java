package com.winter.cloud.auth.infrastructure.service.impl.excel;
...
public class ExcelSelectImpl implements WinterExcelDynamicSelect {
    ...
    public String[] getSource(String type) {
        Response<List<DictDataDTO>> listResponse = dictFacade.dictValueDynamicQueryList(DictDataQuery.builder().dictTypeId(Long.parseLong(type)).build());
